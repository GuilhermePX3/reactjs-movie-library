        ...
        return [
                ...
                <div id="dialogBackground">
                    <div id="panel">
                        ...
                        <div>
                            <div class="ui vertical animated button" onClick={() => this.props.returnDetails(false)} tabindex="0">
                                <div class="hidden content">Back</div>
                                <div class="visible content">
                                    <i class="arrow left icon"></i>
                                </div>
                            </div>
                            <div class="ui vertical animated green button" tabindex="0" onClick={() => this.apiUpdate()}>
